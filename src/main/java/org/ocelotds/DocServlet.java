	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (PrintWriter out = response.getWriter()) {
			...
			String[] docs = new String[]{"/docs/quickstart.html",
				"/docs/features/features.html", "/docs/features/exposesrv.html", "/docs/features/cache.html",
				"/docs/features/push.html", "/docs/features/qos.html", "/docs/features/i18n.html", "/docs/features/security.html",
